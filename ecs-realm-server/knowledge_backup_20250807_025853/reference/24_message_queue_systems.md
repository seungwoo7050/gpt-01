...
public:
    ...
    bool SendPlayerNotification(uint64_t player_id, const PlayerNotification& notification) {
        try {
...
private:
    ...
    void ProcessCombatEventBatch(const std::vector<CombatEvent>& events) {
        ...
        std::unordered_map<uint64_t, float> player_damage;
...
public:
    ...
    bool PublishPlayerAction(uint64_t player_id, const std::string& action, 
...
public:
    ...
    PlayerState ReconstructPlayerState(uint64_t player_id, 
