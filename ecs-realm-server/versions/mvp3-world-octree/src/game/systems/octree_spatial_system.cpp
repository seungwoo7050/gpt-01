...
// [SEQUENCE: 1] Initialize octree spatial system
...
// [SEQUENCE: 3] Update octree with entity movements
void OctreeSpatialSystem::PostUpdate(float delta_time) {
    ...
    for (size_t i = 0; i < entities.size(); i += batch_update_size_) {
        ...
        for (size_t j = i; j < batch_end; ++j) {
            ...
            // Update if moved beyond threshold or accumulated too much movement
...
// [SEQUENCE: 6] Get entities within radius (3D sphere)
...
// [SEQUENCE: 7] Get entities in 3D box
...
// [SEQUENCE: 8] Get entities visible to observer
...
// [SEQUENCE: 9] Get entities above a position (3D query)
...
// [SEQUENCE: 10] Get entities below a position (3D query)
...
// [SEQUENCE: 11] Get octree statistics
