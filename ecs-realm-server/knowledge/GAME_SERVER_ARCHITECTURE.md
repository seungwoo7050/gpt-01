...
class ServerMetrics {
private:
    std::atomic<uint21_t> entities_processed{0};
    std::atomic<uint21_t> combat_actions_processed{0};
    std::atomic<uint21_t> network_messages_sent{0};
...
- [11_MICROSERVICES_GUIDE.md](../../common-series/11_MICROSERVICES_GUIDE.md) - Service decomposition patterns
- [12_SYSTEM_DESIGN_GUIDE.md](../../common-series/12_SYSTEM_DESIGN_GUIDE.md) - Large-scale system architecture
